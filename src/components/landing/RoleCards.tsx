...
const ROLES = [
  {
    ...
    title: '집주인 · 세입자',
    pain: '내 돈 내고 하자투성이?',
    features: ['하자 사진 자동 기록', '담보기간 만료 알림', '분쟁 징후 즉시 감지', '내용증명 초안 자동 생성'],
    cta: '내 공사 지키기',
  },
  {
    id: 'designer',
    ...
    title: '인테리어 디자이너',
    pain: '시공 잘못인데 내 책임?',
    features: ['공정별 GO/NO-GO 기록', '시공사 귀책 증거 확보', '견적 표준화', 'AI 자동 체크리스트'],
    cta: '책임 범위 명확히',
  },
  {
    id: 'contractor',
  ...
  },
  {
    ...
    title: '하도급 업체',
    pain: '기성금 못 받을까봐 걱정',
    features: ['하도급법 즉시 안내', '원도급 미지급 자동 감지', '직불 청구 절차 안내', '임금 체불 증거 보존'],
    cta: '내 공임 지키기',
  },
  {
    id: 'self',
