...
const AI_FEATURES = [
  ...
  },
  {
    ...
    desc: '"구두로 합의했어요"라고 입력하면 체키가 민법 조항과 함께 즉각 경고합니다. 7대 기록 관리 유형 실시간 감지.',
    badge: '자동 실행',
    badgeColor: '#FFB800',
  },
  {
            ...
            {contractorSubStep === 2 && (
              <>
                ...
                <div className={styles.contractorScenarios}>
                  {[
                    { title: '억울한 하자 클레임', desc: '시공 당시 사진이 없어서 억울하게 보수해준 적 있으세요? 체키는 날짜·위치 정보를 포함한 시공 기록를 자동으로 쌓아줘요.' },
